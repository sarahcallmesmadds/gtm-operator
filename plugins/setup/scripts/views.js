...
/**
 * Page identity, for comparing the two halves of a row proof.
 *
 * The parser itself is in `page-id.js`, because `config.js` needs the same
 * question answered about parent pages and should not have to require this file
 * to ask it. Re-exported here because this is where callers already look for it.
 */
